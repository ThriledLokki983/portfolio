export class Project {
    ...
    loadExperience() {
        ...
        // document.querySelector(".project__right-details").appendChild(ul);
        ...
        <div class="${item.className}-img">
            <img srcset="img/${item.photo}-small.png  600w, img/${item.photo} 1000w"
            ...
            projectsParentElement.insertAdjacentHTML("afterbegin", html);
        });
